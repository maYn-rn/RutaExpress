...
public class ShipmentController {
    ...
    @PostMapping
    public ResponseEntity<ShipmentResponseDTO> create(@Valid @RequestBody ShipmentRequestDTO request) {
        ShipmentResponseDTO created = shipmentService.create(request);
